...
def make_radio_config(
    ...
    schema.Radio80211ax2ghzSettings
    | schema.Radio80211gnSettings
    | schema.Radio80211bgSettings
    | schema.Radio80211ax5ghzSettings
    | schema.Radio80211ac5ghzSettings
    | schema.Radio80211anSettings
    | schema.Radio80211aSettings
    | schema.Radio80211ax6ghzSettings
    | schema.Radio80211ad60ghzSettings
]:
    radios = session.exec(
        select(Radio.radio_id).where(Radio.device_id == device.device_id)
    )
